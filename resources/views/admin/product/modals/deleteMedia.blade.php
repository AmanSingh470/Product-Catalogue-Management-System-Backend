    ...
    <div class="relative w-full max-w-md rounded-[12px] bg-white shadow-2xl">
        ...
        <div class="border-b border-[#E5E7EB] px-6 py-5">
            <div class="flex items-start gap-4">
                ...
                {{-- ICON --}}
                <div class="flex size-14 items-center justify-center rounded-full bg-red-50 close-delete-modal-btn">
                ...
                <div class="relative flex-1">
                    <button
                        type="button"
                        class="absolute right-0 top-0 cursor-pointer rounded-md transition hover:bg-gray-100 close-delete-media-modal-btn"
                    >
                    ...
                    <p class="mt-2 text-sm leading-7 text-[#6B7280]">
                        Are you sure you want to delete these media?
        ...
        <div class="flex flex-col-reverse gap-3 border-t border-[#E5E7EB] px-6 py-5 sm:flex-row sm:justify-end">
            ...
            <button
                type="button"
                class="h-[52px] cursor-pointer rounded-[8px] border border-[#D1D5DB] px-6 text-[15px] font-medium text-[#1E1E1E] transition hover:bg-gray-100 close-delete-media-modal-btn"
            >
                Cancel
            </button>
