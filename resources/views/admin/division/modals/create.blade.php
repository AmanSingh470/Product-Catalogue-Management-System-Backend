<div id="add-division-modal" class="flex fixed inset-0 z-50 hidden items-center justify-center bg-black/40 p-4">
    ...
    <div class="w-full max-w-5xl overflow-hidden rounded-[10px] bg-white shadow-2xl">
        ...
        <div class="flex items-start justify-between border-b border-gray-200 px-3 py-3">
            ...
            <button
                type="button"
                class="close-add-division-modal-btn rounded-lg p-2 transition hover:bg-gray-100 cursor-pointer"
            >
        ...
        <div class="max-h-[85vh] overflow-y-auto px-4 py-4 sm:px-8">
            ...
            <form class="space-y-3" id="add-division-form">
                @csrf
                ...
                <div class="flex flex-col-reverse justify-end gap-4 pt-2 sm:flex-row">
                    ...
                    <button
                        type="button"
                        class="close-add-division-modal-btn h-10 rounded-[8px] border border-[#D9DDE3] px-8 text-xs font-medium text-[#1E1E1E] transition hover:bg-gray-100 cursor-pointer"
                    >
                        Cancel
                    </button>
