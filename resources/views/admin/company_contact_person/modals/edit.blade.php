<div id="edit-contactPerson-modal" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
    <div class="w-180 max-w-5xl overflow-hidden rounded-[10px] bg-white shadow-2xl">
        ...
        <div class="flex items-start justify-between border-b border-gray-200 px-3 py-3 sm:px-3">
            ...
            <button class="rounded-lg p-2 transition hover:bg-gray-100 cursor-pointer">
                <x-icons.cross-icon class="size-9 close-edit-contactPerson-modal-btn" />
            </button>
        </div>
        ...
        <div class="max-h-[85vh] overflow-y-auto px-4 py-4 sm:px-8">
            ...
            <form class="space-y-3" id="edit-contactPerson-form">
                @csrf
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 space-y-3">
                    ...
                    <div class="col-span-2 sm:col-span-1">
                        ...
                        <input type="email" value="Electrical and Electronics"
                            class="h-8 w-full rounded-[8px] border border-[#D9DDE3] px-2 text-xs outline-none transition focus:border-red-500" 
                            id="edit-contactPerson-email"
                            name="email"
                            />
                    </div>
                    ...
                    <div class="col-span-2 sm:col-span-1">
                        ...
                        <input type="text" value="Electrical and Electronics"
                            class="h-8 w-full rounded-[8px] border border-[#D9DDE3] px-2 text-xs outline-none transition focus:border-red-500" 
                            id="edit-contactPerson-function"
                            name="function"
                            />
                    </div>
                    ...
                    <div class="col-span-2 sm:col-span-1">
                        ...
                        <select
                            class="h-8 w-full border border-[#D9DDE3] px-2 text-xs outline-none focus:border-red-500 rounded-[8px]"
                            id="edit-contactPerson-company"
                            name="company">
                    ...
                    <div class="col-span-1 sm:col-span-1">
                        ...
                        <div
                            ...
                            <span class="text-xs" id="edit-contactPerson-createdAt">
                    ...
                    <div class="col-span-1 sm:col-span-1">
                        ...
                        <div
                            ...
                            <span class="text-xs"                             id="edit-contactPerson-updatedAt"
>
                ...
                <div class="flex flex-col-reverse justify-end gap-4 pt-2 sm:flex-row">
                    ...
                    <button type="button"
                        class="h-10 rounded-[8px] border border-[#D9DDE3] px-8 text-xs font-medium text-[#1E1E1E] transition hover:bg-gray-100 cursor-pointer close-edit-contactPerson-modal-btn">
                        Cancel
                    </button>
