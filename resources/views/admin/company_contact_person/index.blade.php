...
@section('title', 'Company Contact Person')

@section('content')

@include('admin.company_contact_person.modals.create')
@include('admin.company_contact_person.modals.delete')
@include('admin.company_contact_person.modals.edit')
        ...
        <div class="flex w-full h-25 text-center bg-white rounded-sm shadow-md justify-evenly items-center">
            ...
            <div>
                ...
                <h6 class="text-xs font-semibold mb-1">
                    Total Contact Person
                </h6>

                <h6 class="text-xl text-red-500 font-medium">
                    {{ $stats['totalContactPersons'] }}
                </h6>
    ...
    <div class="w-full lg:w-[40%] bg-white px-5 py-4 mt-5">
        ...
        <div class="flex flex-wrap items-end gap-4">
            ...
            <div class="min-w-[210px] flex-1">
                ...
                @include('admin.company_contact_person.partials.searchbar')
    ...
    <div class="mt-5" id="contactPersons-table">
        @include('admin.company_contact_person.partials.table')
    </div>
