<div id="edit-category-modal" class="flex fixed inset-0 z-50 items-center justify-center bg-black/40 p-4 hidden">
    ...
    <div class="w-full max-w-5xl overflow-hidden rounded-[10px] bg-white shadow-2xl">
        ...
        <div class="flex items-start justify-between border-b border-gray-200 px-3 py-3">
            ...
            <button type="button"
                class="close-edit-category-modal-btn rounded-lg p-2 transition hover:bg-gray-100 cursor-pointer">
            ...
            <form id="edit-category-form">
                ...
                <div class="grid grid-cols-1 gap-3 space-y-3 sm:grid-cols-2">
                    <div class="col-span-1 sm:col-span-2">
                        ...
                        <input type="text" name="name" value="Electrical and Electronics"
                    ...
                    <div class="col-span-1">
                        ...
                        <div
                            ...
                            <span class="text-xs" id="edit-category-createdAt">
                    ...
                    <div class="col-span-1">
                        ...
                        <div
                            ...
                            <span class="text-xs" id="edit-category-updatedAt">
                ...
                <div class="flex flex-col-reverse justify-end gap-4 pt-2 sm:flex-row">
                    ...
                    <button type="button"
                        class="close-edit-category-modal-btn h-10 rounded-[8px] border border-[#D9DDE3] px-8 text-xs font-medium text-[#1E1E1E] transition hover:bg-gray-100 cursor-pointer">
                        Cancel
                    </button>
