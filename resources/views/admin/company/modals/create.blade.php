<div id="add-company-modal" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
    <div class="w-180 max-w-5xl overflow-hidden rounded-[10px] bg-white shadow-2xl">
        ...
        <div class="flex items-start justify-between border-b border-gray-200 px-3 py-3 sm:px-3">
            ...
            <button class="rounded-lg p-2 transition hover:bg-gray-100 cursor-pointer close-add-company-modal-btn">
        ...
        <div class="max-h-[85vh] overflow-y-auto px-4 py-4 sm:px-8">
            ...
            <form class="space-y-3" id="add-company-form">
                @csrf
                <!-- TITLE -->
                <div>
                ...
                <div class="flex flex-col-reverse justify-end gap-4 pt-2 sm:flex-row">
                    ...
                    <button
                        type="button"
                        class="h-10 rounded-[8px] border border-[#D9DDE3] px-8 text-xs font-medium text-[#1E1E1E] transition hover:bg-gray-100 cursor-pointer close-add-company-modal-btn"
                    >
                        Cancel
                    </button>
