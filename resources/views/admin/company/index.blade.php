...
@include('admin.company.modals.create')
@include('admin.company.modals.delete')
@include('admin.company.modals.edit')
    ...
    <div class="w-full lg:w-[40%] bg-white px-5 py-4 mt-5">
        ...
        <div class="flex flex-wrap items-end gap-4">
            ...
            <div class="min-w-[210px] flex-1">
                ...
                @include('admin.company.partials.searchbar')
    ...
    <div class="mt-5" id="company-table">
        @include('admin.company.partials.table')
    </div>
